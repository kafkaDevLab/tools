      ...
      <main className="flex-grow pt-24 pb-12 px-6">
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold mb-2 text-slate-900">색상 변환기</h1>
            <p className="text-slate-500">HEX, RGB, HSL을 실시간으로 변환하고 색상을 확인하세요.</p>
          </div>
              ...
              <div className="flex gap-2">
                {colors.map((slotHex, i) => (
                  <button
                    ...
                    className={`flex-1 min-w-0 h-14 rounded-xl border-2 transition-all shrink-0 ${
                      selectedIndex === i
